/*
  Quiz engine for Context Engineering for Everyone.
  Same page contract as the rest of the TechNaom ecosystem: fill-in-the-blank
  rows and multiple-choice questions, with progress completion on perfect
  score.
*/
...
(function () {
  ...
  function updateScore() {
    ...
    if (perfectScore && window.CEFEProgress) {
      window.CEFEProgress.markComplete(document.body.dataset.chapterId);
    }
  }
