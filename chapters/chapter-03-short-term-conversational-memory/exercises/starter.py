...
# Choose from POLICIES above for each key below.
# ===========================================================================
...
# TODO: assign a policy name from POLICIES to each scenario above.
exercise_1_answers = {
    "single_status_lookup": None,  # TODO
    "long_running_case_review": None,  # TODO
    "fresh_session_no_carryover": None,  # TODO
}
...
# TODO: the first 1-indexed turn number whose cumulative total exceeds
# LINE3_BUDGET, and the cumulative total at that turn.
exercise_3_first_turn_over_budget = None  # TODO: int
exercise_3_cumulative_at_that_turn = None  # TODO: int
...
# TODO: tokens left in Line 3's budget for verbatim turns, and how many
# recent turns that buys at the average per-turn size (integer division).
exercise_4_verbatim_budget = None  # TODO: int
exercise_4_max_verbatim_turns = None  # TODO: int
...
# TODO: for each fact key below, decide True (pin it) or False (don't).
# Pin a fact if it's safety-critical, deadline-critical, or would change
# the case's outcome/eligibility if forgotten. Do not pin small talk or
# facts with no bearing on the model's next answer.
exercise_5_answers = {
    "client_has_pending_eviction_deadline_in_9_days": None,  # TODO
    "client_prefers_email_over_phone": None,  # TODO
    "client_disclosed_domestic_violence_safety_concern": None,  # TODO
    "client_mentioned_liking_the_caseworkers_coffee_order": None,  # TODO
    "client_income_changed_affecting_case_eligibility": None,  # TODO
    "weather_was_bad_during_the_intake_call": None,  # TODO
}
...
# TODO: first turn whose cumulative total reaches or exceeds the trigger
# threshold (compression should start here, before the hard budget hits).
exercise_6_trigger_turn = None  # TODO: int
...
# TODO: sum the three package components; whether the total fits inside
# LINE3_BUDGET; and how much slack (budget minus total) remains.
...
# TODO: does plain recency-based (FIFO) eviction, keeping only the most
# recent NAIVE_VERBATIM_WINDOW_TURNS turns, still contain the turn where
# the pinned fact was disclosed (PINNED_FACT_TURN)? Does the hybrid
# policy (which pins the fact explicitly, independent of position) retain
# it? Hybrid should always be True by definition.
exercise_8_naive_retains_pinned_fact = None  # TODO: bool
exercise_8_hybrid_retains_pinned_fact = None  # TODO: bool
