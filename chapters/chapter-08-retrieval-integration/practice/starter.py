...
# TODO: the set of chunk keys that clear the floor.
scenario_2_survivors = set()  # TODO
...
POPLAR_CROSSING_NAIVE_TOTAL_TOKENS = 310
POPLAR_CROSSING_RECIPE_RESOLVED_TOTAL_TOKENS = 250

# TODO: True/False, and the resolved total.
scenario_7_naive_truncates_load_bearing_clause = None  # TODO
scenario_7_recipe_preserves_load_bearing_clause = None  # TODO
...
# TODO: "proceed_with_bundle" or "surface_no_relevant_result"
scenario_8_answer = ""
...
def score():
    ...
    expected_2 = {key for key, s in ASPENFIELD_CHUNKS.items() if s >= ASPENFIELD_FLOOR}
