...
# TODO: answer "only_with_no_fidelity_check" or "always"
...
scenario_4_missing = None  # TODO: set
scenario_4_passes = None  # TODO: bool
...
# TODO: answer "structured_table" or "narrative_text"
...
scenario_6_answer = None  # TODO: bool
...
scenario_7_answer = None  # TODO: bool
...
def score():
    ...
    results.append(("Scenario 1 (Lynhaven Community Health Partners, judgment)", str(scenario_1_answer).strip().lower() == "only_with_no_fidelity_check", 1))
    ...
    results.append(("Scenario 3 (Coalridge Municipal Transit Authority, judgment)", str(scenario_3_answer).strip().lower() == "no", 1))
    ...
    results.append(("Scenario 5 (Rowancraig Insurance Underwriters, judgment)", str(scenario_5_answer).strip().lower() == "structured_table", 1))
    ...
    results.append(("Scenario 8 (Talmarsh Veterinary Alliance, judgment)", str(scenario_8_answer).strip().lower() == "no", 1))
