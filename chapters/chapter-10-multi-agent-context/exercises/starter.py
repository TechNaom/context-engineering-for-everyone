"""
Chapter 10 Exercises: Context Engineering for Multi-Agent Systems
...
exercise_1_answers = {
    "every_step_gets_full_shift_history_char_cutoff": None,  # TODO
    "steps_scoped_to_current_household_but_no_reset_between_households": None,  # TODO
    "scoped_budgeted_isolated_delegated_handoff": None,  # TODO
}
...
# Compute the naive (unscoped) tokens, the scoped tokens, and whether each
# fits the Match Agent's own 250-token budget.
# ===========================================================================
...
exercise_3_naive_tokens = 0  # TODO
exercise_3_scoped_tokens = 0  # TODO
exercise_3_naive_overflows = None  # TODO (True/False)
exercise_3_scoped_fits = None  # TODO (True/False)
...
# fields; the Match Agent's own contract only needs 3 of them: the
# household id, the eligibility result, and the priority tier (not the
# reasoning trace, caseworker notes, or household size -- the Match
# Agent's own task doesn't use those).
# ===========================================================================
...
# TODO: the set of field keys that should survive curation for the Match Agent.
...
# household and should be evicted. Fill in True/False for each item: True
# = belongs to the current household and survives, False = belongs to a
# prior household and should be evicted.
# ===========================================================================
...
# correctly (has a defined task AND does not include any other
# household's data) or incorrectly.
# ===========================================================================
...
# TODO: True/False for each -- is this payload correctly scoped?
exercise_6_answers = {
    "payload_a": None,  # TODO
    "payload_b": None,  # TODO
    "payload_c": None,  # TODO
...
# pipeline-wide total scoped tokens and total budget.
# ===========================================================================
...
exercise_7_fits_per_step = {
    "intake_agent": None,  # TODO
    "eligibility_agent": None,  # TODO
    "match_agent": None,  # TODO
}
exercise_7_pipeline_total_scoped_tokens = 0  # TODO
exercise_7_pipeline_total_budget = 0  # TODO
...
# "placement_recommendation", has been curated, and is scoped to exactly
# one household (not a mixed multi-household record).
# ===========================================================================
...
# TODO: True/False for each -- is this record ready for downstream handoff?
exercise_8_answers = {
    "record_a": None,  # TODO
    "record_b": None,  # TODO
    "record_c": None,  # TODO
